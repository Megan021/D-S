  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-white rounded-lg shadow-lg w-[95%] md:w-[820px] lg:max-w-screen-lg relative md:flex gap-4" // Added 'relative' for proper positioning of the close button
      >
