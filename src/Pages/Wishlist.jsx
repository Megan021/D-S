      ...
      <div className="container px-4 md:px-0 mt-16">
        {wishlist.length === 0 ? (
          ...
          <div className="text-center my-10">
            <img
              src="/images/wishlist/emptywishlist.webp"
              alt="empty wishlist"
              className="mx-auto w-52 md:w-80"
            />
            ...
            {wishlist.map((wishlist, index) => (
              ...
              >
                ...
                <motion.button
                  ...
                  className="absolute top-3 right-3 bg-white rounded p-2 font-semibold hidden md:block"
                  variants={{
                    rest: {
                      opacity: 0,
                      scale: 0,
                ...
                <motion.button
                  onClick={() => removeFromWishlist(wishlist?.id)}
                  className="absolute top-3 right-3 bg-white rounded p-2 font-semibold md:hidden"
                >
                  <RiDeleteBin5Line />
                </motion.button>
              </motion.div>
